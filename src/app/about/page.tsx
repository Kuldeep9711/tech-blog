    ...
    return (
        ...
        <div className="px-4 sm:px-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto leading-relaxed">
               A modern tech blog real-world development, and thoughful engineering.
            </p>
            </div>
                ...
                <div className="text-center mb-10">
                   <h2 className="text-2xl font-semibold text-gray-200 mb-4">
                    ...
                    <p className= "text-gray-400 max-w-2xl mx-auto leading-relaxed mb-8">
                       Whether you&apos;re just starting out or refining your skills, TechBlog is designed to inspire better codem better designm and better thinking.
                   </p>
